...
public class PrCommand implements CommandHandler {
            ...
            if (next != null) {
                ...
                if (entryCommand != null) {
                    ...
                    if (entryCommand.equalsIgnoreCase("create")) {
                        ...
                        entryCommandCreate(world, name, isGroup);
                        return true;
                    } else if (e == null) {
    ...
    private static void entryCommandCreate(String world, String name, boolean isGroup) {

    }

    private static final int dist = 10;

    private static Entry tryAutoComplete(String world, String partialName, boolean isGroup, MessageHelper msg) {
